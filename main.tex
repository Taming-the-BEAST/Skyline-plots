...
\begin{center}
	...
	\textbf{\LARGE Skyline plots}\\\vspace{2mm}

	% Enter a short description of your tutorial here
	\textbf{\textcolor{mycol}{\Large Inference of past population dynamics using Bayesian Coalescent Skyline
...
To plot the results, we need to tell R where to find the
\lstinline!*.log! file of our run and load it into R (discarding 10\% of
samples as burn-in):
